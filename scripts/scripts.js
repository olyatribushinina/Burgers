...
function modalWindowReview () {

var $reviewBtn = $(".btn-learn-more");
...
for (var i = 0; i < $reviewBtn.length; i++) {
	$reviewBtn.on("click", function() {
		...
		let itemText = $("thisBtn").siblings(".popup-text");
		if (thisBtn.hasClass("btn-learn-more--phone")) {
			$popup.css("display", "block");
         	$("body").appendChild(popup(itemText));
